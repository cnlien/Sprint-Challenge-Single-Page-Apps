...
> Answer: A single network request is required to load the application components which are then stored in the browser memory. This decreases load times and makes for a better user experience.
